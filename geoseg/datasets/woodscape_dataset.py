...
PALETTE = [[0, 0, 0], [255, 0, 255], [0, 0, 255], [0, 255, 0], [255, 0, 0], [255, 255, 255], [0, 255, 255], [255, 255, 0], [255, 128, 128], [128, 128, 0]]


ORIGIN_IMG_SIZE = (966, 1280)
INPUT_IMG_SIZE = (966, 1280)
TEST_IMG_SIZE = (966, 1280)
...
class VaihingenDataset(Dataset):
    def __init__(self, data_root='your_dataset_path', mode='val', img_dir='images/val', mask_dir='gtLabels/val',
        ...
        if mode == "val" or mode == "test":
            img_dir='images/val'
            mask_dir='gtLabels/val'
        else:
            img_dir='images/train'
            mask_dir='gtLabels/train'
